...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  try {
    ...
    let bg = await (await fetch('https://telegra.ph/file/a2f0c320b509b432d4e98.jpg')).buffer()
    await conn.sendTemplateButtonDoc(m.chat, bg, text.trim(), wm, `🏅Owner`, `${_p}owner`, `🎖ThanksTo`, `${_p}tqto`, `🎗  Donasi  🎗`, `${_p}infobot`)
  } catch (e) {
